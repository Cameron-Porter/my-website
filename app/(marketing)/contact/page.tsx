  ...
  return (
    <section className='mx-auto max-w-[840px] px-5 py-16 sm:px-6 md:py-24'>
      <div className='rounded-[2rem] border border-white/10 bg-white/[0.045] p-7 md:p-10'>
        <p className='text-sm font-semibold uppercase tracking-[0.3em] text-accent-gold'>Contact</p>
        ...
        <div className='mt-8 grid gap-3 sm:grid-cols-2'>
          <a className='inline-flex h-12 items-center justify-center gap-2 rounded-full bg-accent-gold px-5 text-sm font-bold text-primary-bg transition hover:bg-accent-gold/90' href={personalSite.links.email}>
