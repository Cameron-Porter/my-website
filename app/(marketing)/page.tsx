...
export default function HomePage() {
  return (
    <div className='relative overflow-hidden'>
      ...
      <div className='pointer-events-none absolute left-1/2 top-0 -z-10 h-[520px] w-[520px] -translate-x-1/2 rounded-full border border-accent-gold/10 bg-accent-gold/[0.03] blur-3xl' />

      <section className='mx-auto grid max-w-[1180px] gap-10 px-5 py-16 sm:px-6 md:py-24 lg:grid-cols-[1.15fr_0.85fr] lg:items-end'>
        <div>
          <p className='text-sm font-semibold uppercase tracking-[0.32em] text-accent-gold'>
          ...
          <div className='mt-9 flex flex-wrap gap-3'>
            <Link className='inline-flex h-12 items-center justify-center gap-2 rounded-full bg-accent-gold px-6 text-sm font-bold text-primary-bg shadow-[0_0_36px_rgba(20,184,166,0.28)] transition hover:bg-accent-gold/90' href='/projects'>
        ...
        <aside className='rounded-[2rem] border border-white/10 bg-white/[0.06] p-6 shadow-[0_0_80px_rgba(245,158,11,0.08)] backdrop-blur-md'>
          <div className='rounded-[1.5rem] border border-accent-gold/20 bg-primary-bg/80 p-5'>
            <div className='flex items-center justify-between gap-4'>
              <p className='text-xs font-bold uppercase tracking-[0.28em] text-accent-gold'>Now building</p>
      ...
      <section className='mx-auto max-w-[1180px] px-5 py-16 sm:px-6' aria-labelledby='projects-heading'>
        <div className='flex flex-col gap-5 md:flex-row md:items-end md:justify-between'>
          <div>
            <p className='text-sm font-semibold uppercase tracking-[0.3em] text-accent-gold'>Selected work</p>
          ...
          <Link className='inline-flex items-center gap-2 text-sm font-semibold text-accent-gold hover:text-primary-text' href='/projects'>
      ...
      <section className='mx-auto max-w-[1180px] px-5 py-16 sm:px-6'>
        <div className='grid gap-6 rounded-[2rem] border border-white/10 bg-[linear-gradient(135deg,rgba(20,184,166,0.12),rgba(245,158,11,0.08))] p-7 md:grid-cols-[0.9fr_1.1fr] md:p-10'>
          <div>
            <p className='text-sm font-semibold uppercase tracking-[0.3em] text-accent-gold'>Resume signal</p>
      ...
      <section className='mx-auto max-w-[1180px] px-5 py-16 sm:px-6'>
        <div className='rounded-[2rem] border border-white/10 bg-white/[0.04] p-8 text-center'>
          <Code2 className='mx-auto text-accent-gold' aria-hidden='true' />
          ...
          <Link className='mt-6 inline-flex h-12 items-center justify-center rounded-full border border-accent-gold/30 px-6 text-sm font-semibold text-accent-gold transition hover:bg-accent-gold/10' href='/lab'>
            Visit the lab
          </Link>
        </div>
      </section>
