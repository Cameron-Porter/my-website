  ...
  return (
    <section className='mx-auto max-w-[1080px] px-5 py-16 sm:px-6 md:py-24'>
      <div className='rounded-[2rem] border border-white/10 bg-[radial-gradient(circle_at_top_right,rgba(245,158,11,0.16),transparent_32%),rgba(255,255,255,0.045)] p-7 md:p-10'>
        <p className='text-sm font-semibold uppercase tracking-[0.3em] text-accent-gold'>The lab</p>
      ...
      <div className='mt-10 rounded-[1.75rem] border border-accent-gold/20 bg-accent-gold/[0.06] p-6'>
        <Sparkles className='text-accent-gold' aria-hidden='true' />
